          ...
          <DialogContentText id="alert-dialog-slide-description">
                ...
                <Typography>
                  <List component="nav" aria-label="main mailbox folders">
                    <ListItem button>
                      ...
                      <ListItemText primary="Fabian Andres Pedraza" />
                    </ListItem>
                    <ListItem button>
                      <ListItemIcon>
                        <PhoneAndroidIcon />
                      </ListItemIcon>
                      <ListItemText primary="+57 3144002058" />
                    </ListItem>
                    <ListItem button>
                      <ListItemIcon>
                        <AlternateEmailIcon />
                      </ListItemIcon>
                      <ListItemText primary="fabianpb923@gmail.com" />
                    </ListItem>
            ...
            >
              <ExpansionPanelSummary
                ...
                id="panel2bh-header"
              >
                <Typography>Paquetes utilizados en Reac</Typography>
              </ExpansionPanelSummary>
              <ExpansionPanelDetails>
                <Typography>
                  <List component="nav" aria-label="main mailbox folders">
                    ...
                    <ListItem button>
                      ...
                      <ListItemText primary="React Redux, Redux Thunk" />
                    </ListItem>
                    <ListItem button>
                      <ListItemIcon>
                        <CardGiftcardIcon />
